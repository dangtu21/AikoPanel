...
class TrojanController extends \App\Http\Controllers\Controller
{
    ...
    public function save(\App\Http\Requests\Admin\ServerTrojanSave $request)
    {
        ...
        if($request->input("id")) {
            $_obfuscated_0D0D125B14041A2F282233210F172D2A320F282D252D01_ = \App\Models\ServerTrojan::find($request->input("id"));
        ...
        if(!\App\Models\ServerTrojan::create($_obfuscated_0D5C34102C3C3C1E36121C1F3B39111A0D013210400E01_)) {
    ...
    public function update(\App\Http\Requests\Admin\ServerTrojanUpdate $request)
    {
    ...
    public function copy(\Illuminate\Http\Request $request)
    {
        ...
        if(!\App\Models\ServerTrojan::create($_obfuscated_0D0D125B14041A2F282233210F172D2A320F282D252D01_->toArray())) {
            abort(500, "Tạo thất bại");
        }
        return response(["data" => true]);
    }
