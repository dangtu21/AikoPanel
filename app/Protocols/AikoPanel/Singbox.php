...
class Singbox
{
    ...
    {
        $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_ = $this->loadConfig();
        $_obfuscated_0D2E3D243C3C1828382912290C3B31093D163D055B1E22_ = $this->buildOutbounds();
        $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_["outbounds"] = $_obfuscated_0D2E3D243C3C1828382912290C3B31093D163D055B1E22_;
        return json_encode($_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_);
    }
    protected function loadConfig()
    {
        $_obfuscated_0D401E100E15352C351B2F37143F321E235C35045B0122_ = new Config\SingBoxConfig($this->user);
        $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_ = $_obfuscated_0D401E100E15352C351B2F37143F321E235C35045B0122_->handle();
    ...
    protected function buildOutbounds()
    {
        ...
        $_obfuscated_0D2205380F243B372811081E0210092B3529370B243801_ = ["tag" => "Lựa chọn nút", "type" => "selector", "default" => "AikoPanel", "outbounds" => ["AikoPanel"]];
        ...
        foreach ($this->servers as $_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_) {
            ...
            if($_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_["type"] === "trojan") {
                $_obfuscated_0D360B3C2926261E5B142529103E5B3435033D40033622_ = $this->buildTrojan($this->user["uuid"], $_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_, $this->custom_sni ?? $this->user["sni"] ?? NULL);
            ...
            if($_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_["type"] === "vmess") {
                $_obfuscated_0D260A05165C0A2B2318142D2B03322C33211D0B3F0B32_ = $this->buildVmess($this->user["uuid"], $_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_, $this->custom_sni ?? $this->user["sni"] ?? NULL);
            ...
            if($_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_["type"] === "vless") {
                $_obfuscated_0D042C095B3E0F251621221E36170E04033E3336313832_ = $this->buildVless($this->user["uuid"], $_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_, $this->custom_sni ?? $this->user["sni"] ?? NULL);
            ...
            if($_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_["type"] === "hysteria") {
                $_obfuscated_0D1C3713010E19270B281E161F15360B400B231D343811_ = $this->buildHysteria($this->user["uuid"], $_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_, $this->user, $this->custom_sni ?? $this->user["sni"] ?? NULL);
    ...
    protected function buildVmess($uuid, $server, $sni)
    {
        $array = [];
        $array["tag"] = $server["name"];
        $array["type"] = "vmess";
        ...
        if($server["tls"]) {
            ...
            if($server["tlsSettings"]) {
                ...
                $_obfuscated_0D1B0238263C3605163B071D112C3F13110823243B0622_["server_name"] = $sni ?? $_obfuscated_0D1C0F19150B050E143C1A1B33363F0C1D0A0831193032_["serverName"] ?? NULL;
            }
        ...
        if($server["network"] === "tcp") {
            ...
            if(isset($_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["request"]["path"][0])) {
                $array["transport"]["path"] = $_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["request"]["path"][0];
            }
        }
        if($server["network"] === "ws") {
            ...
            if($server["networkSettings"]) {
                ...
                if(isset($_obfuscated_0D3B1A310D1E0E300D5B32273306144019350811041632_["headers"]["Host"]) && !empty($_obfuscated_0D3B1A310D1E0E300D5B32273306144019350811041632_["headers"]["Host"])) {
                    $array["transport"]["headers"] = ["Host" => $sni ?? [$_obfuscated_0D3B1A310D1E0E300D5B32273306144019350811041632_["headers"]["Host"]]];
                }
        ...
        if($server["network"] === "grpc") {
            ...
            if($server["networkSettings"]) {
                ...
                if(isset($_obfuscated_0D02035B261D3E1B3F085B062D1C1B2515291232043601_["serviceName"])) {
                    $array["transport"]["service_name"] = $sni ?? $_obfuscated_0D02035B261D3E1B3F085B062D1C1B2515291232043601_["serviceName"];
                }
            }
        }
        return $array;
    }
    protected function buildVless($password, $server, $sni)
    {
        $array = ["type" => "vless", "tag" => $server["name"], "server" => gethostbyname($server["host"]), "server_port" => $server["port"], "uuid" => $password, "packet_encoding" => "xudp"];
        ...
        if($server["tls"]) {
            ...
            if($server["tls_settings"]) {
                ...
                $_obfuscated_0D1B0238263C3605163B071D112C3F13110823243B0622_["server_name"] = $sni ?? $_obfuscated_0D1C0F19150B050E143C1A1B33363F0C1D0A0831193032_["server_name"] ?? NULL;
                if($server["tls"] == 2) {
                ...
                $_obfuscated_0D332F2E192F1D120F37053B1E121B13392D15151A1201_ = isset($server["tls_settings"]["fingerprint"]) ? $server["tls_settings"]["fingerprint"] : "chrome";
                $_obfuscated_0D1B0238263C3605163B071D112C3F13110823243B0622_["utls"] = ["enabled" => true, "fingerprint" => $_obfuscated_0D332F2E192F1D120F37053B1E121B13392D15151A1201_];
            }
            $array["tls"] = $_obfuscated_0D1B0238263C3605163B071D112C3F13110823243B0622_;
        }
        if($server["network"] === "tcp") {
            ...
            if(isset($_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["request"]["headers"]["Host"])) {
                $array["transport"]["host"] = [$_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["request"]["headers"]["Host"]];
            }
            if(isset($_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["request"]["headers"]["Host"])) {
                $array["transport"]["host"] = $_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["request"]["headers"]["Host"];
            }
        ...
        if($server["network"] === "h2") {
            ...
            if($server["network_settings"]) {
                ...
                if(isset($_obfuscated_0D11260806032B2F1D0732050A394016192712052F1F11_["host"])) {
                    $array["transport"]["host"] = $sni ?? [$_obfuscated_0D11260806032B2F1D0732050A394016192712052F1F11_["host"]];
                }
    ...
    protected function buildTrojan($password, $server, $sni)
    {
        $array = [];
        $array["tag"] = $server["name"];
        $array["type"] = "trojan";
        ...
        $array["server_port"] = $server["port"];
        $array["password"] = $password;
        $array["tls"] = ["enabled" => true, "insecure" => $server["allow_insecure"] ? true : false, "server_name" => $sni ?? $server["server_name"]];
        if(isset($server["network"]) && in_array($server["network"], ["grpc", "ws"])) {
            $array["transport"]["type"] = $server["network"];
            if($server["network"] === "grpc" && isset($server["network_settings"]["serviceName"])) {
                $array["transport"]["service_name"] = $sni ?? $server["network_settings"]["serviceName"];
            }
            if($server["network"] === "ws") {
                ...
                if(isset($server["network_settings"]["headers"]["Host"])) {
                    $array["transport"]["headers"] = ["Host" => $sni ?? [$server["network_settings"]["headers"]["Host"]]];
                }
                $array["transport"]["max_early_data"] = 2048;
                $array["transport"]["early_data_header_name"] = "Sec-WebSocket-Protocol";
            }
    ...
    protected function buildHysteria($password, $server, $user, $sni)
    {
        $array = ["server" => gethostbyname($server["host"]), "server_port" => $server["port"], "tls" => ["enabled" => true, "insecure" => $server["insecure"] ? true : false, "server_name" => $sni ?? $server["server_name"]]];
