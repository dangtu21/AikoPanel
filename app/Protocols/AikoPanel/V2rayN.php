...
class V2rayN
{
    ...
    public function handle()
    {
        ...
        foreach ($servers as $_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_) {
            ...
            if($_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_["type"] === "hysteria" && $_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_["version"] == 2) {
                $_obfuscated_0D080F380125280D29073C0B1631011E3D32180C1B1732_ .= self::buildHysteria2($user["uuid"], $_obfuscated_0D1E08373D0613281B195B10390B0A0113053B120E0601_, $_obfuscated_0D1630353D3740130B2A0817293E21263F17115B2C3022_);
            }
        }
    ...
    public static function buildShadowsocks($password, $server)
    {
        ...
        $_obfuscated_0D1606391D130C1A0C050C072A40072A101507082E4001_ = gethostbyname($server["host"]);
        return "ss://" . $_obfuscated_0D1F084040091025030A24192C011F40012E1240341811_ . "@" . $_obfuscated_0D1606391D130C1A0C050C072A40072A101507082E4001_ . ":" . $server["port"] . "#" . $_obfuscated_0D240A0514021D0E06340317112A2212241F29153E1F32_ . "\r\n";
    }
    public static function buildVmess($uuid, $server, $sni)
    {
        $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_ = ["v" => "2", "ps" => $server["name"], "add" => gethostbyname($server["host"]), "port" => (string) $server["port"], "id" => $uuid, "aid" => "0", "net" => $server["network"], "type" => "none", "host" => "", "path" => "", "tls" => $server["tls"] ? "tls" : ""];
        if($server["tls"] && $server["tlsSettings"]) {
            ...
            if(isset($_obfuscated_0D1C0F19150B050E143C1A1B33363F0C1D0A0831193032_["serverName"]) && !empty($_obfuscated_0D1C0F19150B050E143C1A1B33363F0C1D0A0831193032_["serverName"])) {
                $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_["sni"] = $sni ?? $_obfuscated_0D1C0F19150B050E143C1A1B33363F0C1D0A0831193032_["serverName"];
            }
        }
        if((string) $server["network"] === "tcp") {
            ...
            if(isset($_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["type"]) && $_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["type"] == "http") {
                ...
                if(isset($_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["request"]["headers"]["Host"][0])) {
                    $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_["host"] = $sni ?? $_obfuscated_0D3F0127381F133007280319221D250C290D0A0A352B11_["header"]["request"]["headers"]["Host"][0];
                }
        ...
        if((string) $server["network"] === "ws") {
            ...
            if(isset($_obfuscated_0D3B1A310D1E0E300D5B32273306144019350811041632_["headers"]["Host"])) {
                $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_["host"] = $sni ?? $_obfuscated_0D3B1A310D1E0E300D5B32273306144019350811041632_["headers"]["Host"];
            }
        }
    ...
    public static function buildVless($uuid, $server, $sni)
    {
        ...
        if((string) $server["network"] === "tcp") {
            ...
            $_obfuscated_0D0C31223C05281416262E022D393739210402343B0211_ .= "&headerType=" . $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_["headerType"] . "&host=" . $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_["host"] . "&seed=" . $_obfuscated_0D1C2E3B252D3B2C3E162B17052813182B2B121D092D22_["path"];
        }
    ...
    public static function buildTrojan($password, $server, $sni)
    {
        ...
        $_obfuscated_0D1606391D130C1A0C050C072A40072A101507082E4001_ = gethostbyname($server["host"]);
        $_obfuscated_0D080F380125280D29073C0B1631011E3D32180C1B1732_ = "trojan://" . $password . "@" . $_obfuscated_0D1606391D130C1A0C050C072A40072A101507082E4001_ . ":" . $server["port"] . "?" . $query;
    ...
    public static function buildHysteria2($password, $server, $sni)
    {
        if($sni != NULL) {
            $server["server_name"] = $sni;
        }
        $_obfuscated_0D2D170838392E350133132336151D01043607353E1E32_ = filter_var(gethostbyname($server["host"]), FILTER_VALIDATE_IP, FILTER_FLAG_IPV6) ? "[" . gethostbyname($server["host"]) . "]" : gethostbyname($server["host"]);
        ...
        if(isset($server["obfs"]) && isset($server["obfs_password"])) {
            $_obfuscated_0D080F380125280D29073C0B1631011E3D32180C1B1732_ .= "&obfs=" . $server["obfs"] . "&obfs-password=" . $server["obfs_password"];
        }
        $_obfuscated_0D080F380125280D29073C0B1631011E3D32180C1B1732_ .= "#" . $_obfuscated_0D240A0514021D0E06340317112A2212241F29153E1F32_ . "\r\n";
        return $_obfuscated_0D080F380125280D29073C0B1631011E3D32180C1B1732_;
    }
