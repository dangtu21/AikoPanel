...
class ServerHysteria extends \Illuminate\Database\Eloquent\Model
{
    ...
    const FIELD_UP_Mbps = "up_mbps";
    const FIELD_DOWN_Mbps = "down_mbps";
    const FIELD_OBFS = "obfs";
    const FIELD_OBFS_PASSWORD = "obfs_password";
    const FIELD_SERVER_NAME = "server_name";
    const FIELD_INSECURE = "insecure";
